...
public class MainActivity extends AppCompatActivity {
    ...
    AppCompatButton b1, b2, b3, b4, b5, b6, b7, b8, b9 ;
    int turn;
    int draw;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playAgainButton = (AppCompatButton) findViewById(R.id.playAgainButton);
        turn = 1;
        draw = 1;
    ...
    private void endGame() {
        ...
        if(a.equals("X") && b.equals("X") && c.equals("X")) {
            Toast.makeText(MainActivity.this, "Player playing with X has won the game!", Toast.LENGTH_LONG).show();
            end = true;
        ...
        if(a.equals("O") && b.equals("O") && c.equals("O")) {
            Toast.makeText(MainActivity.this, "Player playing with O  has won the game!", Toast.LENGTH_LONG).show();
            end = true;
        }
